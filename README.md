...
This repository contains a Marketing Analytics Toolkit designed as a practical reference for internships and early-career roles in analytics, consulting and marketing strategy. The toolkit explains four core analytical frameworks used in data-driven marketing decision-making, focusing on how they work and how managers use them. Rather than presenting code-heavy analysis, this project emphasizes conceptual clarity, managerial relevance and strategic application.

# **Purpose of the Toolkit**

Modern marketing decisions rely on multiple analytical perspectives. This toolkit serves as a compact, structured guide to help practitioners:

- Select the right analytical method for a business problem
- Understand assumptions and limitations of each model
- Translate analytical outputs into actionable decisions
